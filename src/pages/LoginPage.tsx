...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-32 pb-8">
        <div className="max-w-md w-full">
          {/* Header */}
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-white animate-slideInDown">Welcome Back</h2>
            <p className="text-gray-300 mt-2 animate-slideInUp" style={{ animationDelay: '0.2s' }}>Sign in to bridge your career journey</p>
          </div>
