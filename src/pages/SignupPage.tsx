...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-32 pb-10">
        <div className="max-w-md w-full">
          {/* Header */}
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-white animate-slideInDown">Create Account</h2>
            <p className="text-gray-300 mt-2 animate-slideInUp" style={{ animationDelay: '0.2s' }}>Join thousands of professionals today</p>
          </div>

          {/* Signup Form */}
          <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 p-8 hover:bg-white/15 transition-all duration-300 animate-scaleIn" style={{ animationDelay: '0.4s' }}>
