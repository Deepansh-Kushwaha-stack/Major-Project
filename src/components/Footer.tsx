...
import { Mail, Phone, Instagram, MapPin, Grid as Bridge } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <div className="flex items-center space-x-2 mb-4 group">
              {/* HireBridge Logo */}
              <div className="w-10 h-10 bg-gradient-to-br from-yellow-400 via-amber-400 to-yellow-500 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                <Bridge className="h-6 w-6 text-stone-800 group-hover:text-stone-900 transition-colors duration-300" />
              </div>
